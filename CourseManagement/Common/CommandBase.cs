...
namespace StudentManagementSystem.Common
{
    ...
    public class CommandBase : ICommand
    {
        ...
        public bool CanExecute(object parameter)//逻辑判断
        {
            return DoCanExecute?.Invoke(parameter) == true;//如果DoCanExecute是空的时候会返回Null所以需要转换一下类型 == true
        }
        ...
        public Func<object,bool> DoCanExecute { get; set; }//step1:定义判断的委托
